module Faker
  class Address
    class << self
      ...
      #UA VARIANT
      def ua_area
        ['АР Крым', 'Винницкая область', 'Волынская область', 'Днепропетровская область', 'Донецкая область', 'Житомирская область', 'Закарпатская область', 'Запорожская область', 'Ивано-Франковская область', 'Киев', 'Киевская область', 'Кировоградская область', 'Луганская область', 'Львовская область', 'Николаевская область', 'Одесская область', 'Полтавская область', 'Ровенская область', 'Севастополь', 'Сумская область', 'Тернопольская область', 'Харьковская область', 'Херсонская область', 'Хмельницкая область', 'Черскасская область', 'Черниговская область', 'Черновицкая область'].rand
      end

      def ua_city
        ['Харків', 'Київ', 'Івано-Франківськ', 'Чернівці', 'Мукачеве', 'Севастополь', 'Одеса', 'Ужгород', 'Вінниця', 'Славутич', 'Дніпропетровськ', 'Сімферополь', 'Южний', 'Львів', 'Хмельницький', 'Тернопіль', 'Донецьк', 'Рівне', 'Запоріжжя', 'Полтава', 'Ялта', 'Іллічівськ', 'Кам’янець-Подільський', 'Бориспіль', 'Суми', 'Луцьк', 'Кузнєцовськ', 'Кривий Ріг', 'Трускавець', 'Бровари', 'Миколаїв', 'Комсомольськ', 'Євпаторія', 'Коломия', 'Біла Церква', 'Черкаси', 'Южноукраїнськ', 'Кіровоград', 'Херсон', 'Житомир', 'Умань', 'Алушта', 'Керч', 'Чернігів', 'Енергодар', 'Миргород', 'Ірпінь', 'Переяслав-Хмельницький', 'Луганськ', 'Маріуполь', 'Мелітополь', 'Феодосія', 'Кременчуг', 'Нетішин', 'Артемівськ'].rand
      end

      def ua_street_prefix
        %w(вул. пл. пр.).rand
      end

      def ua_street_name
        [
            Proc.new { [ua_street_prefix, Name.ua_genitive_name].join(' ') },
            Proc.new { [ua_street_prefix, Name.ua_genitive_last_name].join(' ') }
        ].rand.call
      end

      def ua_street_address()
        Faker.numerify([
                           'буд. ##### %s' % ua_street_name,
                           'буд. #### %s' % ua_street_name,
                           'буд. ### %s' % ua_street_name
                       ].rand)
      end
